		...
		<>
			<Navbar bg="white" sticky="top" className="osahan-nav">
				...
				{/* <Navbar.Brand className="mr-1">
					<Link to="/">
						<img className="img-fluid" src={`/img/${darkMode ? 'dark-logo' : 'logo'}.png`} alt="logo" />
					</Link>
				</Navbar.Brand> */}
				{/* Navbar Search*/}
				<Form
				...
				<ul className="navbar-nav ml-auto ml-md-0 osahan-right-navbar">
					...
					<NavDropdown
						title={
							<>
								<img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTUVUH27sngAnS6SnsRdfbuX7XISzFxw-ZVVVgpUWkTBA&s" alt="Avatar" />
								<span className="d-none d-md-inline">
									{" "}
									Osahan
								</span>
